...
/**
  ...
  */
def reflectionClient[Unary[_], Streaming[_], Tag[_]](
  backend: client.ClientBackend[Unary, Streaming, Tag]
)(using Tag[ServerReflectionRequest], Tag[ServerReflectionResponse]): Streaming[ServerReflectionRequest] => Streaming[ServerReflectionResponse] =
